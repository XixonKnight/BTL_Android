package com.example.serviceroom.config.jwt;
...
//            logger.info(Jwts.parser().setSigningKey(SECRET_KEY).parseClaimsJws(token).getBody());
        ...
        } catch (ExpiredJwtException | SignatureException | IllegalArgumentException | MalformedJwtException | UnsupportedJwtException e) {
